...
class Game:
    def __init__(self):
        self.tk = Tk()
        self.tk.title("Hello Mario World")
...
class StickFigureSprite(Sprite):
    def __init__(self, game):
        Sprite.__init__(self, game)
        self.images_left = [
            PhotoImage(file="L-mario2.png"),
            PhotoImage(file="L-mario3.png"),
            PhotoImage(file="L-mario4.png"),
            PhotoImage(file="L-mario5.png"),
        ]
        self.images_right = [
            PhotoImage(file="R-mario2.png"),
            PhotoImage(file="R-mario3.png"),
            PhotoImage(file="R-mario4.png"),
            PhotoImage(file="R-mario5.png"),
        ]
    ...
    def animate(self):
        ...
        if self.x < 0:
            if self.y != 0:
                self.game.canvas.itemconfig(self.image, image=self.images_left[3])
            else:
                self.game.canvas.itemconfig(self.image, image=self.images_left[self.current_image])
        elif self.x > 0:
            if self.y != 0:
                self.game.canvas.itemconfig(self.image, image=self.images_right[3])
            else:
...
class DoorSprite(Sprite):
    def __init__(self, game, photo_image1, x, y, width, height):
        Sprite.__init__(self, game)
        self.photo_image = photo_image1
        self.image = game.canvas.create_image(x, y, image=self.photo_image, anchor='nw')
...
door = DoorSprite(g, PhotoImage(file="pitch1.png"), 45, 30, 40, 35)
